...
const urgencyOptions = [
  { value: 'normal', label: 'Normal - sous 1 semaine', color: 'border-green-300 bg-green-50 text-green-700' },
  { value: 'urgent', label: 'Urgent - sous 48h', color: 'border-amber-300 bg-amber-50 text-amber-700' },
  { value: 'tres-urgent', label: 'Très urgent - aujourd\'hui', color: 'border-red-300 bg-red-50 text-red-700' },
]
  ...
  if (state?.success) {
    return (
      ...
      >
        ...
        <h3 className="mb-2 text-xl font-semibold text-green-800">Demande envoyée !</h3>
          ...
          {urgencyOptions.map((option) => (
            <label
              ...
              className={cn(
                ...
                selectedUrgency === option.value ? option.color : 'border-slate-200 bg-white text-slate-600',
              )}
            >
              <input
                type="radio"
